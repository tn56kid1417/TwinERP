...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
 ...
 <div className="bg-[#1A1D23] border border-slate-800 rounded-lg p-8 max-w-md w-full text-center shadow-lg">
 ...
 className="px-4 py-2.5 bg-rose-600/20 hover:bg-rose-600/30 text-rose-400 border border-rose-500/30 text-xs font-bold rounded-lg transition-colors"
 >
 Clear Cache & Logout
 </button>
 </div>
...
export default function App() {
 ...
 <div className="flex h-screen w-screen overflow-hidden bg-slate-50 text-slate-700 font-sans relative z-0">
