...
export const LandingPage: React.FC = () => {
 ...
 {/* Navigation Bar */}
 <nav className="fixed top-0 left-0 right-0 h-16 border-b border-slate-200 bg-white/80 z-50 flex items-center justify-between px-6 md:px-12">
 ...
 <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3 py-1 bg-primary text-primary-foreground rounded-full text-xs font-bold ">
 Most Popular
 </div>
 <CardContent className="p-8 flex-1 flex flex-col justify-between text-left space-y-6">
 <div className="space-y-2">
