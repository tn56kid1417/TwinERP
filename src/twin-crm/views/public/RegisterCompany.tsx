...
export const RegisterCompany: React.FC = () => {
 ...
 <div className="p-3 bg-primary text-primary-foreground rounded-lg flex items-center justify-center shadow-lg shadow-primary/20">
 <BarChart3 size={24} />
 </div>
 ...
 <Card className="bg-white border-slate-200 shadow-lg shadow-slate-900/10 dark:shadow-black/80 relative overflow-hidden">
 <CardHeader className="pb-3 border-b border-slate-100">
 <CardTitle className="text-center text-xl font-extrabold text-slate-900">
 ...
 {/* Progress Bar */}
 {step < 4 && (
 <div className="w-full bg-slate-200 h-1.5 rounded-full mt-4 relative overflow-hidden">
 <div
 ...
 <select
 className="w-full text-sm py-2.5 px-3.5 bg-white border border-slate-200 text-slate-800 rounded-md outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 cursor-pointer shadow-sm [color-scheme:light] dark:[color-scheme:dark]"
 {...register('companySize')}
 >
 <option value="1–10 Employees"className="bg-white text-slate-800">1–10 Employees</option>
 <option value="11–50 Employees"className="bg-white text-slate-800">11–50 Employees</option>
 <option value="51–100 Employees"className="bg-white text-slate-800">51–100 Employees</option>
 <option value="101–500 Employees"className="bg-white text-slate-800">101–500 Employees</option>
 <option value="500+ Employees"className="bg-white text-slate-800">500+ Employees</option>
 </select>
 </div>
 ...
 <span className="text-[10px] text-slate-500 font-bold block">Your Custom Workspace URL</span>
 ...
 <span className="text-xs font-bold text-slate-850 block">Recommended Next Steps:</span>
