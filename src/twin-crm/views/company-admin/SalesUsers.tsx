        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          {(user?.designation === 'CEO' || user?.designation === 'CTO') && (
            <Button 
              ...
              className="flex items-center gap-2 cursor-pointer w-full sm:w-auto shadow-sm bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
