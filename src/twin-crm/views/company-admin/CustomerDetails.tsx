...
export const CustomerDetails: React.FC = () => {
 ...
 {/* Headers tabs */}
 <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-4 h-14 flex-shrink-0">
 ...
 className="flex-1 text-sm py-2.5 px-4 bg-white border border-slate-200 text-slate-800 placeholder:text-slate-400 rounded-md outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 shadow-sm"
 />
 ...
 <span className={cn('text-xs font-bold', isSystem ? 'text-blue-600 dark:text-blue-600' : 'text-slate-800')}>
 {note.authorName}
 </span>
 ...
 <p className="text-xs text-slate-600 leading-relaxed font-normal">{note.text}</p>
 </div>
 )
 })
 )}
