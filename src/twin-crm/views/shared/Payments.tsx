...
export const Payments: React.FC = () => {
 ...
 header: 'LEAD',
 accessor: (row) => (
 <span className="font-medium text-slate-900 whitespace-nowrap">{getLeadName(row.leadId)}</span>
 ),
 },
 {
 header: 'TYPE',
 ...
 header: 'CREATED BY',
 accessor: (row) => (
 <span className="text-slate-600 whitespace-nowrap">{row.createdBy || 'System'}</span>
 ),
 },
 {
 header: 'APPROVAL',
 ...
 return (
 <Badge variant={approval === 'Awaiting' ? 'secondary' : 'secondary'} className="text-xs px-2 py-0.5 whitespace-nowrap bg-slate-100 text-slate-600 border border-slate-200">
 ...
 header: 'APPROVER',
 accessor: (row) => (
 <span className="text-slate-600 whitespace-nowrap">{row.approver || '-'}</span>
 ),
 },
 {
 header: 'EXPIRES',
 ...
 return (
 <div className="flex items-center gap-2">
 <span className={`text-xs whitespace-nowrap ${isOverdue ? 'text-red-500 font-semibold' : 'text-slate-600'}`}>
 ...
 header: 'DATE',
 accessor: (row) => (
 <span className="text-slate-600 text-xs whitespace-nowrap">{formatDate(row.date)}</span>
 ),
 },
 {
 header: 'ACTIONS',
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors text-xs font-medium"
 >
 <Edit2 size={12} />
 Update
 </button>
 ...
 variant="outline"
 size="sm"
 className="border-red-200 dark:border-red-800/30 text-red-700 dark:text-red-400 hover:bg-red-50"
 ...
 <div className="flex items-center justify-between">
 <span className="text-2xl font-extrabold text-slate-900 tracking-tight">₹ {totalRevenue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-2xl font-extrabold text-slate-900 tracking-tight">{successRate}%</span>
 ...
 className="pl-9 pr-4 py-2 bg-white border border-slate-300 rounded-lg text-sm text-slate-900 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-primary dark:focus:border-slate-700 w-64"
 value={searchQuery}
 ...
 <select
 className="appearance-none pl-9 pr-8 py-2 bg-white border border-slate-300 rounded-lg text-sm text-slate-700 hover:bg-slate-50 transition-colors focus:outline-none focus:border-primary dark:focus:border-slate-700 cursor-pointer"
 value={statusFilter}
 ...
 <div className="flex items-center gap-3">
 <button onClick={handleExportCSV} className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
 ...
 <select
 className="w-full text-sm py-2.5 px-3.5 bg-white border border-slate-200 text-slate-800 rounded-md transition-all duration-200 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 appearance-none cursor-pointer shadow-sm"
 ...
 >
 <option value="Full"className="bg-white text-slate-800">Full</option>
 <option value="Partial"className="bg-white text-slate-800">Partial</option>
 </select>
 </div>
