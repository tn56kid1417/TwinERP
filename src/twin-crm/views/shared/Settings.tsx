...
export const SettingsView: React.FC = () => {
 ...
 {/* Mock photo upload */}
 <div className="flex items-center gap-4 p-4 border border-slate-200 rounded-xl bg-slate-50/70/60">
 <div className="w-14 h-14 bg-blue-600 text-white flex items-center justify-center rounded-xl font-bold text-lg uppercase shadow-sm">
 {user?.name.charAt(0)}
 </div>
 <div className="space-y-1">
 <span className="text-xs font-bold text-slate-800 block">Profile Avatar Image</span>
 <button
 type="button"
 onClick={() => alert('Demo: Choose a local image to update profile avatar.')}
 className="px-3 py-1 bg-white border border-slate-200/80 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50 flex items-center gap-1.5 cursor-pointer transition-colors"
 >
 ...
 {/* Corporate Logo mock */}
 <div className="flex items-center gap-4 p-4 border border-slate-200 rounded-xl bg-slate-50/70/60">
 <div className="w-14 h-14 bg-blue-600/15 text-blue-600 dark:text-blue-600 flex items-center justify-center rounded-xl font-extrabold shadow-sm border border-blue-200">
 <Building size={24} />
 </div>
 <div className="space-y-1">
 <span className="text-xs font-bold text-slate-800 block">Corporate Logo</span>
 <button
 type="button"
