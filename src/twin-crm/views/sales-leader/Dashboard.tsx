...
export const SalesLeaderDashboard: React.FC = () => {
 ...
 <div>
 <h1 className="text-2xl font-bold tracking-tight text-slate-900">Sales Leader Dashboard</h1>
 ...
 <span className="text-xs font-semibold text-slate-500 block ">Team Members</span>
 <span className="text-2xl font-extrabold text-slate-900 block mt-0.5 tracking-tight">{teamMembers.length}</span>
 </div>
 </CardContent>
 </Card>
 ...
 <div className="flex-1 text-left">
 <span className="text-xs font-semibold text-slate-500 block ">Pending/Unassigned Leads</span>
 <span className="text-2xl font-extrabold text-slate-900 block mt-0.5 tracking-tight">{unassignedLeads}</span>
 </div>
 </CardContent>
 </Card>
 ...
 <span className="text-2xl font-extrabold text-slate-900 block mt-0.5 tracking-tight">{leads.length}</span>
 </div>
 </CardContent>
 </Card>
 </div>
