...
export function JobCard({
  ...
  return (
    <Card className="group flex flex-col overflow-hidden bg-white dark:bg-[#12161F] border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm hover:shadow-[0_8px_30px_rgba(8,38,84,0.12)] hover:border-[#0099d6]/40 hover:-translate-y-1 transition-all duration-200" style={{ fontFamily: 'Figtree, Inter, sans-serif' }}>
      {/* Top accent bar */}
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-1 gap-4">
        ...
        <div className="flex items-start gap-3.5">
          <div className="h-10 w-10 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center shrink-0 group-hover:bg-[#082654] group-hover:border-[#082654] group-hover:text-white transition-colors">
            <Briefcase className="h-5 w-5 text-slate-500 group-hover:text-white transition-colors" />
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="text-[16px] font-semibold leading-tight text-slate-900 dark:text-white line-clamp-2 group-hover:text-[#0099d6] transition-colors">
              {job.title}
            </h3>
            <div className="mt-1.5 flex flex-wrap items-center gap-2 text-xs">
              ...
              {job.publishedAt && (
                <>
                  <span className="h-1 w-1 rounded-full bg-slate-300 dark:bg-slate-700 hidden sm:inline" />
          ...
          <div className="pt-1">
            {!isExpanded ? (
              <Button
                onClick={toggle}
                variant="outline"
                className="w-full justify-between rounded-full border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-[#082654] hover:text-white text-sm h-9"
              >
                More Info
              ...
              <div className="space-y-3">
                <div className="rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3.5 space-y-2.5">
                ...
                <div className="flex gap-2">
                  <Button variant="ghost" size="sm" onClick={toggle} className="flex-1 gap-1 text-slate-500 hover:text-slate-900 dark:hover:text-white rounded-full">
        ...
        {/* Footer actions */}
        <div className="mt-auto flex items-center gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
          <Button
            variant="ghost"
            size="sm"
            className="flex-1 rounded-full text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-[#082654] dark:hover:text-white gap-1.5"
