...
export function DialogContent({ children, className }: { children: React.ReactNode; className?: string }) {
 ...
 return (
 <div className={twMerge(clsx("relative mx-auto w-full max-w-lg rounded-lg bg-white p-6 shadow-lg border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100", className))}>
 <button
 type="button"
