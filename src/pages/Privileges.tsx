...
export default function Privileges() {
 ...
 {/* Legend */}
 <div className="flex items-center gap-3 text-xs text-slate-500 bg-white/70 border border-slate-200 rounded-xl px-4 py-2.5">
 ...
 <div className="relative bg-white rounded-lg border border-slate-200 p-4 shadow-sm overflow-hidden">
 <p className="text-[11px] font-medium text-slate-500">Custom Privileges Set</p>
 ...
 className="w-full pl-9 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 outline-none focus:border-blue-500 transition-colors shadow-sm"
 />
 </div>
 ...
 >
 {/* Top accent */}
 <div className={`absolute inset-x-0 top-0 h-[2px] ${hasCustom ? 'bg-gradient-to-r from-transparent via-amber-500/80 to-transparent' : 'bg-gradient-to-r from-transparent via-blue-500/20 to-transparent'}`} />
 ...
 <div className={`w-9 h-9 rounded-full bg-${avatarColor(u.name)} text-white flex items-center justify-center text-xs font-bold shadow-md shrink-0`}>
 {getInitials(u.name)}
 </div>
 <div>
 ...
 {/* Badges */}
 <span className="px-2 py-0.5 rounded-full text-[11px] font-medium bg-blue-600/10 text-blue-600 border border-blue-600/20">
 {u.role}
 </span>
 {hasCustom && (
 <span className="px-2 py-0.5 rounded-full text-[11px] font-medium bg-amber-500/10 text-amber-500 border border-amber-500/20 flex items-center gap-1">
 ...
 className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 rounded-lg hover:bg-emerald-500/20 transition-colors"
 >
 <Check size={11} /> Grant All
 </button>
 <button
 onClick={() => revokeAll(u.id)}
 className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium bg-rose-500/10 text-rose-500 border border-rose-500/20 rounded-lg hover:bg-rose-500/20 transition-colors"
 >
 <X size={11} /> Revoke All
 </button>
 <button
 onClick={() => resetToDefault(u.id)}
 className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium bg-slate-500/10 text-slate-500 border border-slate-300 rounded-lg hover:bg-slate-500/20 transition-colors"
 >
 ...
 className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 rounded-lg hover:bg-amber-500/20 transition-colors"
 >
 ...
 return (
 <div className="bg-blue-50/70 dark:bg-indigo-950/20 border border-blue-200/80 dark:border-blue-800/50 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-xs">
 <div className="space-y-1">
 <div className="flex items-center gap-2">
 <ListTodo className="h-4 w-4 text-blue-600 dark:text-blue-600"/>
 ...
 className={`flex items-center gap-2 px-3.5 py-2 rounded-md border text-xs font-bold transition-all shadow-sm shrink-0 cursor-pointer ${
 canAssign
 ...
 className={`flex items-center justify-between gap-2 px-3 py-2.5 rounded-md border text-xs font-semibold transition-all duration-200 text-left ${
 isOn
 ? 'bg-blue-600/10 border-blue-200 text-blue-700 text-blue-600 shadow-sm'
 : 'bg-slate-50 border-slate-200 text-slate-400'
 }`}
 >
 <span className="flex items-center gap-2">
 <span className={isOn ? 'text-blue-600' : 'text-slate-400'}>
 {mod.icon}
 </span>
 {mod.label}
 </span>
 {isOn
 ? <ToggleRight size={16} className="text-blue-600 shrink-0"/>
 : <ToggleLeft size={16} className="text-slate-300 shrink-0"/>
 }
 </button>
 );
 })}
 ...
 className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white text-xs font-bold rounded-md transition-all shadow-md shadow-blue-600/30 active:scale-95"
 >
 <Save size={14} />
