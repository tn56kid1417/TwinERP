...
const LetterGenerator = () => {
 ...
 <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Letter Generator</h1>
 <p className="text-slate-500 text-sm">
 Upload a .docx template containing <code className="bg-slate-100 px-1 py-0.5 rounded text-blue-400">{`{name}`}</code> and <code className="bg-slate-100 px-1 py-0.5 rounded text-blue-400">{`{role}`}</code> placeholders to generate custom letters.
 </p>
 </div>
 ...
 className={`flex-1 py-3 px-4 rounded-md border font-medium transition-all ${
 letterType === 'offer'
 ...
 {/* Upload Section */}
 <div className="relative bg-white border border-slate-200 rounded-lg p-6 overflow-hidden flex flex-col items-center justify-center min-h-[300px] shadow-lg shadow-slate-200/50 dark:shadow-black/40">
 <input
 type="file"
 accept=".docx"
 ...
 {file ? (
 <>
 <div className="w-16 h-16 bg-blue-600/15 text-blue-600 dark:text-blue-600 rounded-full flex items-center justify-center border border-blue-200 shadow-lg shadow-blue-600/15">
 <FileText size={32} />
 </div>
 <div>
 ...
 <div className="text-blue-600 dark:text-blue-600 text-sm font-medium">Click or drag to replace template</div>
 </>
 ) : (
 <>
 <div className="w-16 h-16 bg-slate-100 text-slate-500 rounded-full flex items-center justify-center border border-slate-200 transition-colors">
 <UploadCloud size={32} />
 </div>
 <div>
 <p className="text-sm font-semibold text-slate-800">Upload Template</p>
 <p className="text-xs text-slate-500 mt-1">Select a .docx file to use as a template</p>
 </div>
 </>
 )}
 </div>
 ...
 {/* Form Section */}
 <div className="relative bg-white border border-slate-200 rounded-lg p-6 shadow-lg shadow-slate-200/50 dark:shadow-black/40 overflow-hidden">
 ...
 className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed mt-4 cursor-pointer text-xs "
 >
 {isGenerating ? (
