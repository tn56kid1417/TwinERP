...
export default function Lifecycle() {
 ...
 <TrendingUp className="text-blue-600 dark:text-blue-600 h-7 w-7 sm:h-8 sm:w-8"/>
 Employee Lifecycle
 </h1>
 ...
 className="px-2.5 py-1 text-xs bg-slate-50 border border-slate-200 rounded-lg text-slate-800 outline-none"
 >
 ...
 {terminations.map((t) => (
 <tr key={t.id}>
 <td className="py-4 px-6 font-bold text-slate-900">{t.employeeId}</td>
